...
Baik Pertama-tama buatlah sebuah Folder Praktikum5 dan didalamnya diisi File List.py & Praktikum5.py seperti berikut :

Note Untuk penamaan folder dan file bisa sesuai keinginan kalian

img folder

Selanjutnya buka file List.py lalu masukan code dibawah ini :
...
# membuat 5 list dengan type data yang berbeda
 ...
 print(listGabungan)
Selanjutnya jalankan file dengan cara buka terminal lalu ketikan python List.py dan berikut hasilnya :
...
Package Tabulate
Pertama kita install Package Tabulate dengan cara buka terminal lalu copas pip install tabulate sebagai berikut :

tabulate

Lalu buka file Praktikum5.py dan masukan code berikut
...
Selanjutnya jalankan file dengan cara buka terminal lalu ketikan python Praktikum5.py dan berikut hasilnya :

hasil praktium5

Selesai terima kasih# praktikum5
